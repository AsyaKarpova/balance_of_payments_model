...
vars = all_vars %>% select(-'dum01':-'dum12', -'dum_2012', -'dum_1114', -'n_j':-'n_ds', -'n_y',-'n_c', -'n_g', -'vcor')
...
X_oil = all_vars[1:end_2018, ] %>% 
  select(const, brent, brent_1, rub_usd_1) 
R_oil = all_vars[1:end_2018, ] %>% 
...
mape(pred_oil$v_hat_oil[(end_2013-12):end_2013], all_vars$v_exp_oil[(end_2013-12):end_2013])
mape(pred_oil$r_hat_oil[(end_2013-12):end_2013], all_vars$r_exp_oil[(end_2013-12):end_2013])
mape(pred_oil$p_hat_oil[(end_2013-12):end_2013], all_vars$p_exp_oil[(end_2013-12):end_2013])
...
mape(pred_op$v_hat_op[(end_2013-12):end_2013], all_vars$v_exp_op[(end_2013-12):end_2013])
mape(pred_op$r_hat_op[(end_2013-12):end_2013], all_vars$r_exp_op[(end_2013-12):end_2013])
mape(pred_op$p_hat_op[(end_2013-12):end_2013], all_vars$p_exp_op[(end_2013-12):end_2013])
...
mape(pred_gas$v_hat_gas[(end_2013-12):end_2013], all_vars$v_exp_gas[(end_2013-12):end_2013])
mape(pred_gas$r_hat_gas[(end_2013-12):end_2013], all_vars$r_exp_gas[(end_2013-12):end_2013])
mape(pred_gas$p_hat_gas[(end_2013-12):end_2013], all_vars$p_exp_gas[(end_2013-12):end_2013])
...
mape(r_hat_othg[(end_2013-12):end_2013], all_vars$r_exp_othg[(end_2013-12):end_2013])
mape(r_hat_gds[(end_2018-12):end_2013], all_vars$r_exp_goods[(end_2018-12):end_2013])


# Model for goods import (restore monthly data!!!!) (r_imp_goods^ + r_imp_serv^ + r_imp_all^)

X_imp = tibble(consump_defl = lag(all_vars$n_c, 1)[1:end_2018]/all_vars$rub_usd_1[1:end_2018],
               j_defl = lag(all_vars$n_j, 1)[1:end_2018]/all_vars$rub_usd_1[1:end_2018],
               ds_defl = (all_vars$n_ds_1)[1:end_2018]/all_vars$rub_usd_1[1:end_2018],
               r_hat_gds = r_hat_gds)
...
autoplot(ts.union(real_data = ts(all_vars$r_imp_serv[1:end_2018], start = c(2006, 1), freq = 12),  
...
autoplot(ts.union(real_data = ts(all_vars$r_imp_all[1:end_2018], start = c(2006, 1), freq = 12),  
...
mape(r_hat_imp_gds, all_vars$r_imp_goods[(end_2018-12):end_2018])
mape(r_hat_imp_serv[(start_2012-12):end_2018], all_vars$r_imp_serv[(start_2012-12):end_2018])
mape(r_hat_imp_all[(start_2012-12):end_2018], all_vars$r_imp_all[(start_2012-12):end_2018])
...
mape(r_hat_exp_serv[(start_2012-12):end_2018], all_vars$r_exp_serv[(start_2012-12):end_2018])
...
mape(r_hat_rent_sinc[(start_2012-12):end_2018], (all_vars$r_bal_rent + all_vars$r_bal_sinc)[(start_2012-12):end_2018])
mase(r_hat_rent_sinc[(start_2012-12):end_2018], (all_vars$r_bal_rent + all_vars$r_bal_sinc)[(start_2012-12):end_2018])
smape(r_hat_rent_sinc[(start_2012-12):end_2018], (all_vars$r_bal_rent + all_vars$r_bal_sinc)[(start_2012-12):end_2018])
...
mape(r_hat_inv[(start_2012-12):end_2018], all_vars$r_bal_inv[(start_2012-12):end_2018])
...
mape(r_hat_wage[(start_2012-12):end_2018], all_vars$r_bal_wage[(start_2012-12):end_2018])
mase(r_hat_wage[(start_2012-12):end_2018], all_vars$r_bal_wage[(start_2012-12):end_2018])
smape(r_hat_wage[(start_2012-12):end_2018], all_vars$r_bal_wage[(start_2012-12):end_2018])
...
mape(r_hat_errors[(start_2012-12):end_2018], all_vars$r_errors[(start_2012-12):end_2018])
mase(r_hat_errors[(start_2012-12):end_2018], all_vars$r_errors[(start_2012-12):end_2018])
smape(r_hat_errors[(start_2012-12):end_2018], all_vars$r_errors[(start_2012-12):end_2018])
...
mape(r_hat_dif_res_short[(start_2012-12):(end_2018)], all_vars$r_dif_reserves[(start_2012-12):(end_2018)])
