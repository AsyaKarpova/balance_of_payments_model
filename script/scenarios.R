...
pred_untill_2021_base = predict_bp(all_vars1, par_model)
restored_data_2021_base = pred_untill_2020[[1]]
predictions_2021_base = pred_untill_2020[[2]]


pred_untill_2021_good = predict_bp(all_vars2, par_model)
restored_data_2021_good = pred_untill_2021_base[[1]]
predictions_2021_good = pred_untill_2020[[2]]

pred_untill_2021_neg = predict_bp(all_vars3, par_model)
